        ...
        <div>
          ...
          <p className="mt-2 text-gray-200 max-w-xl">Machine Learning and Full-Stack Developer with internship experience at Arbisoft, skilled in building intelligent systems and scalable web applications. Projects below are fetched from my GitHub account.</p>
            ...
            <div className="mt-4 flex gap-3">
              ...
              <a href="https://github.com/sameeramir959" target="_blank" rel="noreferrer" className="px-4 py-2 bg-white/10 rounded-md flex items-center gap-2 hover:bg-white/20 transition">
            ...
            <div className="mt-4 flex gap-3 text-sm">
              <a href="https://github.com/sameeramir959" target="_blank" rel="noreferrer" className="text-gray-200 hover:text-white">GitHub</a>
